...
import {
  MapPin, Globe, Settings, CheckCircle,
  User, Package, Lock, Shield, ChevronLeft,
} from 'lucide-react';
...
const Section = ({ title, children }) => (
  <div className="mb-10">
    <h2 className="text-xl font-bold text-amber-300 mb-4 flex items-center gap-2">
      <span className="w-1 h-6 rounded-full bg-amber-400 inline-block flex-shrink-0" />
      {title}
    </h2>
...
const permissions = [
  { perm: 'ACCESS_FINE_LOCATION / COARSE', reason: 'To fetch GPS coordinates for prayer times and Qibla direction' },
    ...
    >
      ...
      >
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center gap-4">
          <Link
            to="/"
            className="flex items-center gap-1.5 text-slate-400 hover:text-amber-400 transition-colors duration-300 no-underline text-sm font-medium group"
          >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-16">
        ...
        >
          ...
          <Section title="1. App Overview">
            <p>
              ...
              Available on Android via Google Play under package{' '}
              <span className="font-mono text-emerald-400 text-xs bg-black/30 px-2 py-0.5 rounded">com.sk_altamash188.noor</span>.
            </p>
            <p>
              Noor provides Islamic features including Prayer Times, Quran Reader, Qibla Compass,
              Audio Recitation, Duas, and Hijri Calendar — all free, with no ads.
            </p>
          </Section>
          ...
          <Section title="2. Information We Collect">
            ...
            <div className="space-y-4 mt-3">
              {dataItems.map((item) => (
                ...
                >
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center border flex-shrink-0 ${item.iconBg}`}>
          ...
          <Section title="3. Third-Party APIs Used">
            ...
            <p className="mt-3">
              These APIs are queried over HTTPS. No personal identifiers are ever transmitted.
            </p>
          </Section>
          ...
          <Section title="6. Data Storage & Security">
            <p>
              All user preferences are stored exclusively on your device using{' '}
              <span className="font-mono text-emerald-400 text-xs">AsyncStorage</span>.
          ...
          <Section title="7. Children's Privacy">
            <p>
              ...
              Since no personal data is collected from any user, there is no risk of misuse.
            </p>
          </Section>
          ...
          <Section title="9. Contact Us">
            ...
            <div
              className="mt-3 p-5 rounded-xl border border-amber-400/20 inline-flex flex-col gap-3"
        ...
        {/* Footer note */}
        <div className="text-center mt-10 text-slate-600 text-xs space-y-2">
          <p>© {new Date().getFullYear()} Noor App · Sk Altamash · All rights reserved</p>
          <p className="font-amiri text-amber-300/30 text-base">اللَّهُ نُورُ السَّمَاوَاتِ وَالْأَرْضِ</p>
        </div>
